...
<head>
    ...
    <title>Créer un Livre/Chapitre - SoundTable</title>
    ...
    <div class="container">
        ...
        <form id="livre-form">
            ...
            <div class="form-group">
                ...
                <input type="number" name="chapitreNB" value="1" required>
            </div>
            <div class="form-group">
                <label>Statut</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="categorie" placeholder="Ex: JDR, Fantasy, gratuit">
            </div>
            <div class="form-group">
